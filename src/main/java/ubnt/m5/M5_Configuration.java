...
//            System.setProperty("webdriver.gecko.driver","D:\\SeleniumGecko\\geckodriver.exe");
    ...
    private final Log log = LogFactory.getLog(M5_Configuration.class);
    ...
    public int configM5(String side,String updatedSSID,String updatedIP,String updatedNetmask,String updateGatewayIP,
        ...
        if (side.equals("AP")){
            ...
            UpdateConfigFilee.updateFile(updatedSSID,updatedIP,updatedNetmask,updateGatewayIP,null,updatedMACAddress,side);
        }
