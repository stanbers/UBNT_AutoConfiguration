...
import utility.UpdateConfigFile_Absolute;
 ...
 */
public class M5_Configuration_Absolute {
     {
...
//        System.setProperty("webdriver.gecko.driver",System.getProperty("user.dir")+"\\SeleniumGecko\\geckodriver.exe");
    ...
    private final Log log = LogFactory.getLog(M5_Configuration_Absolute.class);
...
//        System.setProperty("webdriver.gecko.driver","D:\\SeleniumGecko\\geckodriver.exe");
        ...
        if (side.equals("AP")){
            UpdateConfigFile_Absolute.updateFile(updatedSSID,updatedIP,updatedNetmask,updateGatewayIP,updatedFruq,null,side);
        }
        else if (side.equals("ST")){
            UpdateConfigFile_Absolute.updateFile(updatedSSID,updatedIP,updatedNetmask,updateGatewayIP,null,updatedMACAddress,side);
        }
