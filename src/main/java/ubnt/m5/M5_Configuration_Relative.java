...
import utility.UpdateConfigFile_Relative;
 ...
 */
public class M5_Configuration_Relative {
     {
//            System.setProperty("webdriver.gecko.driver","D:\\SeleniumGecko\\geckodriver.exe");
    ...
    private final Log log = LogFactory.getLog(M5_Configuration_Relative.class);
...
//        System.setProperty("webdriver.gecko.driver","D:\\SeleniumGecko\\geckodriver.exe");
        ...
        if (side.equals("AP")){
            UpdateConfigFile_Relative.updateFile(updatedSSID,updatedIP,updatedNetmask,updateGatewayIP,updatedFruq,null,side);
        }
        else if (side.equals("ST")){
            UpdateConfigFile_Relative.updateFile(updatedSSID,updatedIP,updatedNetmask,updateGatewayIP,null,updatedMACAddress,side);
        }
