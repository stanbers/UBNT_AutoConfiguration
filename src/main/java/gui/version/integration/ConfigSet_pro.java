...
import gui.version.wallhanging.WallHangingGUI_pro;
 ...
 */
public class ConfigSet_pro {

    private final static Log log = LogFactory.getLog(ConfigSet_pro.class);
...
//                    exportToExcel(tableModel_wall,"D:\\ConfigFile\\wall\\"+pName_wall+".xlsx",4);
                    exportToExcel(tableModel_wall,System.getProperty("user.dir")+"\\ConfigFile\\wall\\"+pName_wall+".xlsx",4);
                }
...
//                            jTable.setModel(defaultTableModel);
                ...
                final JPanel outermostPanel_wall = new WallHangingGUI_pro().showConfigRecordsPage(pName_wall,pNumber_wall,tableModel_wall,commonFields);
                JPanel outermostHeaderPanel = new JPanel(){
                    @Override
                    public void paintComponent(Graphics graphics){
                        super.paintComponent(graphics);
                ...
                homepagePanel.setVisible(false);
                new WallHangingGUI_pro().showConfigRecordsPage(pName_wall,pNumber_wall,tableModel_wall,commonFields).setVisible(true);
