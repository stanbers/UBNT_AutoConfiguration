...
//        System.setProperty("webdriver.gecko.driver",System.getProperty("user.dir")+"\\SeleniumGecko\\geckodriver.exe");
    ...
    private final Log log = LogFactory.getLog(WallHanging.class);

    private final String URL = "http://admin:admin@10.10.100.254/index_cn.html";

    public void config(String ssidName, String wallHangingIP, String wallHangingNetmask, String wallHangingGatewayIP, String serverIP){
        driver.get(URL);
        try {
